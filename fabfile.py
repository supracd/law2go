...
def bootstrap_app():
    ...
    print 'TODO:'
    print '   Create and configure .env'
    print '   Install virtualenv requirements'
    print '   Sync and migrate database'
    print '   Collect static files'
    print '   Configure apache http.conf'
